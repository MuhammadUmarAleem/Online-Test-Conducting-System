...
class _AIExamState extends State<AIExam> {
  ...
  final List<Question> _questions = [
    ...
    Question(
        ...
        options: {
          'To solve artificial problems': false,
          'To extract scientific causes': false,
          'To explain various sorts of intelligence': true,
          'To solve real-world problems': false
        }),
  ];
  int index = 0;
...
//score of the student
  ...
  Color correctColor =
      Colors.green.shade800; // You can change this to the color you want
  Color incorrectColor =
      Colors.red.shade800; // You can change this to the color you want
