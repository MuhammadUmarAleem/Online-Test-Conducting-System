      ...
      setState(() {
        if (_quizTimer < 1) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => getIndResult(
                  quizId: widget.quizId,
                  quizTitle: widget.quizTitle,
                  noOfQuestions: widget.noOfQuestions,
                  trueAnswers: totalScore),
            ),
          );
        } else {
          _quizTimer--;
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Image(
                  image: AssetImage("assets/images/pen_on_paper.png"),
                  height: 150,
                ),
                SizedBox(
                  width: 20,
              ...
              child: StreamBuilder<List<DocumentSnapshot>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final List<DocumentSnapshot<Object?>> documentList =
                        snapshot.data!;
                    ...
                    final String currentQuestion =
                        documentList[currentQuestionIndex]["Question"];
                    final String trueAnswer =
                        documentList[currentQuestionIndex]['trueAnswer'];
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          trueOption(
                              prefix: "a",
                              text: options[currentQuestionIndex]['Option1'],
                              index: currentQuestionIndex,
                              onTap: () {
                                _isSeleted = true;
                                if (trueAnswer ==
                                    options[currentQuestionIndex]['Option1']) {
                                  scoreValue = 1;
                                } else {
                                  scoreValue = 0;
                                }
                          ...
                          trueOption(
                              prefix: "b",
                              text: options[currentQuestionIndex]['Option2'],
                              index: currentQuestionIndex,
                              onTap: () {
                                _isSeleted = true;
                                if (trueAnswer ==
                                    options[currentQuestionIndex]['Option2']) {
                                  scoreValue = 1;
                                } else {
                                  scoreValue = 0;
                                }
                          ...
                          trueOption(
                              prefix: "c",
                              text: options[currentQuestionIndex]['Option3'],
                              index: currentQuestionIndex,
                              onTap: () {
                                _isSeleted = true;
                                if (trueAnswer ==
                                    options[currentQuestionIndex]['Option3']) {
                                  scoreValue = 1;
                                } else {
                                  scoreValue = 0;
                                }
                          ...
                          trueOption(
                              prefix: "d",
                              text: options[currentQuestionIndex]['Option4'],
                              index: currentQuestionIndex,
                              onTap: () {
                                _isSeleted = true;
                                if (trueAnswer ==
                                    options[currentQuestionIndex]['Option4']) {
                                  scoreValue = 1;
                                } else {
                                  scoreValue = 0;
                                }
                                  ...
                                  GestureDetector(
                                      onTap: () {
                                        if (_isSeleted == false) {
                                          ...
                                          _isSeleted = false;
                                          print(
                                              "gesture index: $currentQuestionIndex");
                                          print(
                                              "total questions ${documentList.length}");
...
class quizQuestion extends StatelessWidget {
  ...
  const quizQuestion(
      {super.key, required this.question, required this.currentQuestionIndex});
