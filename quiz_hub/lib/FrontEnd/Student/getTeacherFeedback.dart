...
class GetTeacherFeedback extends StatefulWidget {
  const GetTeacherFeedback({super.key});
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  child: Text("AI Feedback", style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 25, fontWeight: FontWeight.w600)),
                ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  child: Text("SE Feedback", style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 25, fontWeight: FontWeight.w600)),
                ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  child: Text("PPSD Feedback", style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 25, fontWeight: FontWeight.w600)),
                ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  child: Text("CN Feedback", style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 25, fontWeight: FontWeight.w600)),
                ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  child: Text("MAD Feedback", style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 25, fontWeight: FontWeight.w600)),
                ),
