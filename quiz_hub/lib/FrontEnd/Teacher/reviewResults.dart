...
import 'package:quiz_hub/FrontEnd/Teacher/reviewSubjectWiseResult.dart';
import 'package:quiz_hub/models/constants.dart';

class ReviewResultsByTeacher extends StatefulWidget {
  const ReviewResultsByTeacher({super.key});

  @override
  State<ReviewResultsByTeacher> createState() => _ReviewResultsByTeacherState();
}

class _ReviewResultsByTeacherState extends State<ReviewResultsByTeacher> {
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => ReviewSubjectWiseResult(
                        subjectName: 'AI'),
                    ),
                    );
                  },
